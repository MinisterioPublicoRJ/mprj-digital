...
export const PRODUCT_COMPONENT_DATA = (nextPos, extraFilters) => `${BASE_URL}?q=type:produtos&start=${nextPos}${extraFilters}&fl=title,name,res_name,res_url,res_format,extras_product_thumbnail_description,extras_ordem_aparecimento`;
